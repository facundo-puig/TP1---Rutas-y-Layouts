    ...
    <nav className="bg-zinc-900 border-b border-zinc-800 px-6 py-4 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-6 text-sm items-center">
          <Link
            href="/productos" className="flex items-center gap-2 text-purple-400 font-bold hover:text-white transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-3.5 h-3.5 bi bi-star-fill" viewBox="0 0 16 16">
